...
export async function POST(request) {
  ...
  return Response.json({
    ...
    manifest:{
      ...
      script:input.script,
      production:{videoMode:input.videoMode || "avatar",editStyle:input.editStyle,recommendedStyleIds:recommendedStyleIds(domain.id,format.id),visualPolicy:{semanticCutsOnly:true,stockIsContextOnly:true,sourceOrder:["owned-assets","designed-proof","pexels","pixabay","presenter-or-typography"]}},
